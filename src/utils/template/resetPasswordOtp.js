...
160%;"><span style="font-size: 18px; line-height: 28.8px;">Your
one-time-password for the email address <strong><span style="color: #046a38;
line-height: 22.4px;">${email}</span></strong> is</span></p>
                                <p style="font-size: 14px; line-height:
160%;"><span style="font-size: 20px; line-height: 32px;"><span
style="text-decoration: underline; line-height: 22.4px;"><strong><span
style="line-height: 22.4px; color: #046a38; text-decoration: underline;">${otp}</span></strong></span></span></p>
                              </div>
